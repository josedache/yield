...
export function trackUserSignUp(
  ...
  export function trackUserInputBVN(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserAllPageLoads(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserClickOnAnExistingYield(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserClickOnCreateNewYield(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserClickOnContactUs(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserUponSelectingTheNumberOfMonthsForYield(
    ...
    try {
      trackUser(mixpanelEvents.upon_selecting_the_number_of_months_for_yield, {...payload})
    } catch (error) {
      console.error("Error tracking selecting the number of months for yield", error);
    }
  }
  ...
  export function trackUserInputBasicInfo(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserPaystack(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserYieldActivation(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserProfileUpdate(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserOnSelectingClaim(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserOnSelectingInterest(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserOnSelectingCapital(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserOnSelectingCapitalOnly(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserOnSelectingRollover(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserUponProceedToPay(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserUponReturnToDashboard(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserUponCompletePayment(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserUponNamingYield(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserAddBankAccount(
    payload: Record<string, any>
  ) {
    try {
  ...
  export function trackUserDocumentVerification(
    payload: Record<string, any>
  ) {
    try {
