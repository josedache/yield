...
export default function FixedPlanDetails(props: DrawerProps) {
  ...
  const details = [
    { title: "Creation Date", value: "12th December, 2021" },
    { title: "Maturity Date", value: "12th December, 2022" },
    ...
    <Drawer anchor="right" {...rest}>
      <div>
        <div className="flex justify-between gap-2 items-center">
          <Typography variant="h5">Detty December</Typography>
        ...
        <div className="w-full md:w-[70%] mt-6 px-6">
          ...
          <Typography variant="body2" color="primary" className="mt-2 md:mt-4">
            +₦3,782.15
          </Typography>
        </div>
        ...
        <div className="mt-6">
          <div className="px-6 flex justify-between">
            <Typography className="font-semibold px-6">Transactions</Typography>
            <Link className="font-semibold px-6">View All</Link>
          </div>
          <Divider className="mt-2" />
          <div className="px-6 mt-4 grid grid-cols-1 gap-6  mb-8">
